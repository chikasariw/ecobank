...
export function BalanceCard() {
  return (
    <div className="w-full lg:w-1/3 overflow-hidden rounded-3xl bg-gradient-to-br from-eb-primary-green-500 to-eb-primary-green-400 p-6 py-10 text-white mb-3">
